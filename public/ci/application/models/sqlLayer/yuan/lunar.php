...
class Lunar extends CI_Model {
  ...
  * @param date 公历-日 
  */ 
  function rzy($year,$month,$date){//debugger; 
    $rar=$this->convertSolarToLunar($year,$month,$date); 
	$ym=(int)sprintf("%04d",$year).sprintf("%02d",$month);
	if($ym>=191201 and $ym<194910){
	$rar[8]="中华民国";
	$rar[9]="民国";
	}if($ym>=194910){
	$rar[8]="中华人民共和国";
